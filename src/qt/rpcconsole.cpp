                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHERBPathCustom = GetArg("-zherbbackuppath", "");
    ...
    if(!strzHERBPathCustom.empty()) {
        ui->wallet_customzherbbackuppath->setText(QString::fromStdString(strzHERBPathCustom));
        ui->wallet_customzherbbackuppath_label->setVisible(true);
        ui->wallet_customzherbbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHERBPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Herbcoin RPC console.") + "<br>" +
