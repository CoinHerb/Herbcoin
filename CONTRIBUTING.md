Contributing to Herbcoin Core
============================

The Herbcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/herbcoin-project/herbcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Herbcoin Core project, and is not to be
confused with overall Herbcoin Network Protocol consensus changes.

Whether a pull request is merged into Herbcoin Core rests with the project merge
...
Patches that change Herbcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Herbcoin consensus, it must have been
...
The project leader is the release manager for each Herbcoin Core release.
