...
/* Herbcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Herbcoin"
#define QAPP_ORG_DOMAIN "herbcoin.org"
#define QAPP_APP_NAME_DEFAULT "Herbcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Herbcoin-Qt-testnet"
