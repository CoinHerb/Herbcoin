...
/** Utility functions used by the Herbcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Herbcoin addresses in monospace font
...
// Parse "herbcoin:" URI into recipient object, return true on successful parsing
