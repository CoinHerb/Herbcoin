...
/**
 * Herbcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZherbSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzherbseed(const UniValue& params, bool fHelp);
extern UniValue getzherbseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzherb(const UniValue& params, bool fHelp);
extern UniValue dzherbstate(const UniValue& params, bool fHelp);
