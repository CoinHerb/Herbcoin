...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::HERB);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeHerbcoinAmount"))
        SoftSetArg("-anonymizeherbcoinamount", settings.value("nAnonymizeHerbcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in herbcoin.cpp during shotdown to also remove the window positions
