...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Herbcoin Core herbcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  herbcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded herbcoin transaction") + "\n" +
                               "  herbcoin-tx [options] -create [commands]   " + _("Create hex-encoded herbcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded herbcoin transaction
