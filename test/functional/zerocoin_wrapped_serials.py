...
from fake_stake.base_test import Herbcoin_FakeStakeTest

class zHERBwrappedSerialsTest(Herbcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zHERBs..." % DENOM_TO_USE)
