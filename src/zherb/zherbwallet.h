...
#ifndef Herbcoin_ZHERBWALLET_H
#define Herbcoin_ZHERBWALLET_H
...
public:
    CzHERBWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHERB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHERB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
