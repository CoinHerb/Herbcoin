...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Herbcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Herbcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Herbcoin features */
        {"herbcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"herbcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"herbcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"herbcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"herbcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"herbcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"herbcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"herbcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"herbcoin", "startmasternode", &startmasternode, true, true, false},
        {"herbcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"herbcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"herbcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"herbcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"herbcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"herbcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"herbcoin", "preparebudget", &preparebudget, true, true, false},
        {"herbcoin", "submitbudget", &submitbudget, true, true, false},
        {"herbcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"herbcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"herbcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"herbcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"herbcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"herbcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"herbcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"herbcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"herbcoin", "mnsync", &mnsync, true, true, false},
        {"herbcoin", "spork", &spork, true, true, false},
        {"herbcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzherbseed", &getzherbseed, false, false, true},
        {"zerocoin", "setzherbseed", &setzherbseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzherb", &searchdzherb, false, false, true},
        {"zerocoin", "dzherbstate", &dzherbstate, false, false, true},
...
{
    return "> herbcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30615/\n";
}
