...
#ifndef Herbcoin_ZHERBTRACKER_H
#define Herbcoin_ZHERBTRACKER_H
...
public:
    CzHERBTracker(std::string strWalletFile);
    ~CzHERBTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzHERBWallet* zHERBWallet = NULL);
