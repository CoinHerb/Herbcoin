...
RESOURCES += src/qt/herbcoin.qrc src/qt/herbcoin_locale.qrc

TRANSLATIONS += src/qt/locale/herbcoin_bg.ts \
                src/qt/locale/herbcoin_de.ts \
                src/qt/locale/herbcoin_en.ts \
                src/qt/locale/herbcoin_es.ts \
                src/qt/locale/herbcoin_fi.ts \
                src/qt/locale/herbcoin_fr.ts \
                src/qt/locale/herbcoin_it.ts \
                src/qt/locale/herbcoin_ja.ts \
                src/qt/locale/herbcoin_pl.ts \
                src/qt/locale/herbcoin_pt.ts \
                src/qt/locale/herbcoin_ru.ts \
                src/qt/locale/herbcoin_sk.ts \
                src/qt/locale/herbcoin_sv.ts \
                src/qt/locale/herbcoin_vi.ts \
                src/qt/locale/herbcoin_zh_CN.ts \
                src/qt/locale/herbcoin_zh_TW.ts
